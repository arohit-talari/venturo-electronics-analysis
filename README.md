...
Venturo's customer base spans approximately **$52,000**$ customers across **$110,000+**$ transactions, generating **$65M+**$ in revenue. The data captures key dimensions, including region, product line, marketing channel, order channel, and loyalty status, and tracks core KPIs such as revenue, average order value (AOV), order volume, customer retention, and refund rate. The business operates in a competitive, macro-sensitive environment. Rising inflation, changing consuming spending habits, and growing competitiion from peer retailers have all shaped Venturo's performance across the four-year period.
...
<p align="center">
<img src="images/regional_baseline.png" width="900" height="416">
</p>
